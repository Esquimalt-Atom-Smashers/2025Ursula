 ...
 */
public class ElevatorTrapezoidalToPosCommand extends Command {
  ...
  public ElevatorTrapezoidalToPosCommand(double targetPositionInches,ElevatorSubsystem elevatorSubsystem) {
